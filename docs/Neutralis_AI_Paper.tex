...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{img/Confusion-Matrix.png}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\linewidth]{img/Heat-Map.png}
\caption{Comprehensive multi-metric performance heatmap summarizing Neutralis-AI across five ethical detection categories (e.g., Privacy Concerns, Bias/Stereotyping, Misinformation, Manipulation Patterns, and Confirmation Bias) using eight technical metrics including TPR, Precision, Recall, F1-score, Accuracy, Specificity, MCC, and AUC. The visualization highlights Privacy Concerns as the highest-performing category across the evaluated metrics.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{img/Line-chart.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{img/Latency-Bar-chart.png}}
